...
OMNIROUTE_BASE_URL = env('OMNIROUTE_BASE_URL', default='http://omniroute:20128/v1')
OMNIROUTE_API_KEY = env('OMNIROUTE_API_KEY', default='')
OMNIROUTE_MODEL = env('OMNIROUTE_MODEL', default='auto')
OMNIROUTE_TIMEOUT_SECONDS = env.float('OMNIROUTE_TIMEOUT_SECONDS', default=90.0)
